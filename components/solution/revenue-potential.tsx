    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <h3 className="text-2xl font-semibold text-navy-900 mb-6 text-center">User Testimonials</h3>
            ...
            {[
              {
                ...
                quote:
                  "I've earned over $500 in just three months by sharing my shopping preferences. It's amazing to be compensated for data I was giving away for free before!",
              },
              {
                name: "Michael R.",
                avatar: "/placeholder.svg?height=80&width=80",
                quote:
                  "As a frequent traveler, sharing my location data has been incredibly lucrative. Consentd has changed the way I think about my personal information.",
              },
              {
                name: "Emily T.",
                avatar: "/placeholder.svg?height=80&width=80",
                quote:
                  "I love how transparent Consentd is about data usage. I feel in control of my information and it's great to be rewarded for it.",
              },
              ...
              <div key={index} className="bg-gray-50 p-6 rounded-lg shadow-sm">
                ...
                <p className="text-navy-600 italic">"{testimonial.quote}"</p>
              </div>
            ))}
          </div>
        </motion.div>
