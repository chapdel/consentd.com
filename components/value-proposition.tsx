    ...
    <section className="section-padding bg-gray-50" ref={ref}>
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-navy-600 max-w-3xl mx-auto text-wrap">
            A Basic Profile can make you a tune of up to{" "}
            <span className="font-bold text-turquoise-500">$6000/year</span>
          </p>
        </motion.div>
