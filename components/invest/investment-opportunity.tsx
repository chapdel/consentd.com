      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <h3 className="text-2xl font-semibold text-navy-900 mb-6">Funding Goal: $1M</h3>
            <p className="text-navy-600 mb-6">
              We're seeking $1 million in seed funding to accelerate our growth and solidify our position as the leader
              in ethical data monetization.
            </p>
            <h4 className="text-xl font-semibold text-navy-900 mb-4">Fund Allocation</h4>
