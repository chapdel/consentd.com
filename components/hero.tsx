        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Control & Monetize Your Data on Your Terms
            </h1>
            <p className="text-lg md:text-xl opacity-90 mb-8 max-w-xl">
              Take charge of your personal data. With Consentd, you decide who can access it, keep it secure, and get
              rewarded for sharing—on your own terms.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-white bg-blue-800 text-white hover:bg-blue-900 hover:border-blue-800 transition-colors duration-300"
              >
                Join Waitlist
              </Button>
            </div>
